...
```{r cumprob, fig.cap="Cummulative Probability of Exceedance"}
...
\end{equation}
```
Sometimes the issue is the probability of exceeding that threshold in any one year in a *t* year period. For that case it is the summation of the geometric probability from 1 to *t*.
